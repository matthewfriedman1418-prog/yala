...
export default function AppError({
  ...
  return (
    <div
      ...
      style={{ background: '#0C1812', border: '1px solid rgba(239,68,68,0.25)' }}
    >
      <div
      ...
      <p className="text-sm mb-2" style={{ color: '#8FA899' }}>
        We hit an unexpected error loading this page. Your balance and account are unaffected.
      </p>
      {error.digest && (
        <p className="text-[10px] font-mono mb-6" style={{ color: '#4A6A55' }}>
          ref: {error.digest}
        </p>
      )}
